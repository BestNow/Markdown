...
| 名称                              | 图标                                                         | 描述                                                         |
| :-------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| **预览网格体（Preview Mesh）**    | <img src="Image/物体和角色动画制作/骨架网格体动画系统/动画编辑器/PreviewMeshIcon.png" alt="PreviewMeshIcon" style="zoom:200%;" /> | 为当前资产设置一个新的预览骨架网格体（在动画或骨骼前储存）。 |
